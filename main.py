    """
    Disk Usage Cli 6zu6m9j
    ======================
    A fast CLI utility to clean files and directories straight from the terminal.
    ...
    APP_NAME    = "Disk Usage Cli 6zu6m9j"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A fast CLI utility to clean files and directories straight from the terminal.")
